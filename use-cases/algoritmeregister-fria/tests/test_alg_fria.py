"""Tests voor Algoritmeregister + FRIA."""
...
JREM_PATH = (
    Path(__file__).parent.parent / "jrem/exports/algoritmeregister-fria-2026.1.json"
)
...
class TestJREM:
    ...
    def test_domain(self, jrem):
        assert jrem["domain"] == "algoritmeregister-fria"

    def test_rules(self, jrem):
        assert len(jrem["rules"]) == 20
