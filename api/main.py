...
# Prototype stores and experimental capabilities are local-only. Production
# exposes only health and template routes until their evidence gates are closed.
if API_PROFILE == "prototype":
    app.include_router(
