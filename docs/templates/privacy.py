    ...
    return {
        ...
        "inhoud": {
            ...
            "sectie_7": {
                ...
                "content": "[Beschrijf welke cookies worden gebruikt]\n\n- Functionele cookies (noodzakelijk)\n- Analytische cookies (met toestemming)\n- Marketing cookies (met toestemming)\n\nBeheer uw voorkeuren via: [cookie-instellingen]",
            },
            "sectie_8": {
                "titel": "8. Wijzigingen",
                "content": f"Deze privacyverklaring kan worden gewijzigd. De meest recente versie is altijd beschikbaar op [website].\n\nLaatst bijgewerkt: {date.today().isoformat()}",
            },
        },
    }
            ...
            "template_tabel": [
                {
                    ...
                    "doel": "[doel]",
                    "rechtsgrond": "[Art. 6]",
                    "gegevens_categorieen": "[lijst]",
                    "betrokkenen_categorieen": "[lijst]",
                    "ontvangers": "[lijst]",
                    "bewaartermijn": "[termijn]",
                    "beveiliging": "[maatregelen]",
                    "doorgifte_buiten_eu": "[Ja/Nee + waarborgen]",
                },
            ],
            "voorbeeld_verwerkingen": [
                {
                    "verwerking": "Personeelsadministratie",
                    "doel": "Salaris, verlof, ziekte",
                    "rechtsgrond": "Art. 6(1)(b)/(c)",
                    "gegevens": "Naam, adres, salaris, BSN",
                    "betrokkenen": "Medewerkers",
                    "ontvangers": "Salarisadministratie, Belastingdienst",
                    "bewaartermijn": "7 jaar",
                    "beveiliging": "Encryptie, toegangscontrole, logging",
                },
                {
                    "verwerking": "Klantenservice",
                    "doel": "Afhandelen vragen en klachten",
                    "rechtsgrond": "Art. 6(1)(b)",
                    "gegevens": "Naam, contact, geschiedenis",
                    "betrokkenen": "Burgers",
                    "ontvangers": "Geen",
                    "bewaartermijn": "2 jaar na afhandeling",
                    "beveiliging": "Toegangscontrole, encryptie",
                },
                {
                    "verwerking": "Website-statistieken",
                    "doel": "Inzicht gebruik website",
                    "rechtsgrond": "Art. 6(1)(f) / toestemming",
                    "gegevens": "IP-adres, cookies",
                    "betrokkenen": "Websitebezoekers",
                    "ontvangers": "Google Analytics (SCC)",
                    "bewaartermijn": "26 maanden",
                    "beveiliging": "Pseudonimisering",
                },
            ],
        },
    }
...
def toestemmingsregister_template(org_naam: str, **kwargs) -> dict:
    ...
    return {
        ...
        "inhoud": {
            ...
            "template": [
                {
                    "betrokkene": "[naam/initiaal]",
                    "doel": "[doel]",
                    "gegevens": "[categorieen]",
                    "verkregen_op": "[datum]",
                    "methode": "[online/formulier/mondeling]",
                    "intrekking_mogelijk": "[Ja/Nee]",
                    "introkken_op": "[datum of leeg]",
                },
            ],
            "vereisten": [
