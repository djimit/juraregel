# Review Request — BIO2 Compliance Rules

## Use case: `bio2`

**Domein:** Baseline Informatiebeveiliging Overheid 2 — maatregelen conform BIO2 v1.2
...
De use case bevat 18 testscenario's die de regels valideren. De jurist kan deze scenario's gebruiken om randgevallen en uitzonderingen te identificeren die mogelijk ontbreken.
...
- **Na review:** Resultaten worden vastgelegd in `docs/review-results/bio2.md`
