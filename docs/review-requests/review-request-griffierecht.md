# Review Request — Griffierecht Rule Service

## Use case: `griffierecht`

**Domein:** Civiele dagvaardingszaken en kantonzaken — bepaling griffierecht bij zaakintake
...
- Rechtspraak.nl tarieventabellen 2025/2026
...
De use case bevat 56 testscenario's die de regels valideren. De jurist kan deze scenario's gebruiken om randgevallen en uitzonderingen te identificeren die mogelijk ontbreken.
...
- **Na review:** Resultaten worden vastgelegd in `docs/review-results/griffierecht.md`
