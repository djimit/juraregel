# Review Request — API Registratie Rules

## Use case: `api-registratie`

**Domein:** API registratie — regels voor publicatie en registratie van overheids-APIs
...
- **Na review:** Resultaten worden vastgelegd in `docs/review-results/api-registratie.md`
