# Review Request — Participatiewet Bijstandsuitkering Rule Service

## Use case: `participatiewet`

**Domein:** Participatiewet — bepaling bijstandsnorm, vermogensgrens, kostendelersnorm, vrijlating inkomen en plichten
...
- Besluit bijstandsnormen 2025
- Besluit vermogensgrenzen 2025
- Besluit kostendelersnorm 2025
- Besluit vrijlating inkomsten 2025
...
De use case bevat 17 testscenario's die de regels valideren. De jurist kan deze scenario's gebruiken om randgevallen en uitzonderingen te identificeren die mogelijk ontbreken.
...
- **Na review:** Resultaten worden vastgelegd in `docs/review-results/participatiewet.md`
