# Review Request — AVG/GDPR Rules

## Use case: `avg-gdpr`

**Domein:** Algemene Verordening Gegevensbescherming — verwerkingsgronden en rechten betrokkene
...
- **Na review:** Resultaten worden vastgelegd in `docs/review-results/avg-gdpr.md`
