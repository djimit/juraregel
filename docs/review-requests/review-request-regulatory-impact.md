# Review Request — Regulatory Impact Rules

## Use case: `regulatory-impact`

**Domein:** Regulatory impact — impactanalyse van wetswijzigingen op bestaande systemen
...
- **Na review:** Resultaten worden vastgelegd in `docs/review-results/regulatory-impact.md`
