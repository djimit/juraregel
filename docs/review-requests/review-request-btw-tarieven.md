# Review Request — BTW Tarieven Rules

## Use case: `btw-tarieven`

**Domein:** BTW tarieven — bepaling juist tarief per goederen/dienstencategorie
...
- **Na review:** Resultaten worden vastgelegd in `docs/review-results/btw-tarieven.md`
